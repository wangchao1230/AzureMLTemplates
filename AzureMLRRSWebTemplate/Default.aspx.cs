...
namespace AzureMLRRSWebTemplate
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        public object GetSwaggerFormatScoreRequest(Dictionary<string, string> columnsDictionary)
        {
            var scoreRequest = new
            {
                Inputs = new Dictionary<string, List<Dictionary<string, string>>>() {
                        {
                            "input1",
                            new List<Dictionary<string, string>>(){columnsDictionary
                            }
                        },
                    },
        ...
        public object GetStringTableScoreRequest(Dictionary<string, string> columnsDictionary)
        {
            ...
            strtable.Values = new string[1, values.Length];
        ...
        public object GetScoreRequest(Dictionary<string, string> columnsDictionary)
        {
            if (webServicePostUrl.Contains("format=swagger"))
            {
                return GetSwaggerFormatScoreRequest(columnsDictionary);
            }
            else {
                return GetStringTableScoreRequest(columnsDictionary);
            }
        }
